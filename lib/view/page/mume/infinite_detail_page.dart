          ...
          Container(
            ...
            decoration: const BoxDecoration(
              ...
              borderRadius: BorderRadius.only(
                bottomLeft: Radius.circular(Sizes.circular),
                bottomRight: Radius.circular(Sizes.circular),
              )
            ),
            child: Container(
              child: Column(
                    ...
                    children: [
                      Container(
                        child: Badge(
                          ...
                          badgeContent: Text(widget.infiniteDetail!.infiniteState!, style: const TextStyle(fontSize: 12, color: Colors.white)),
                        )
                      ),
                      Row(
                        ...
                        children: [
                          ...
                          if(widget.infiniteDetail!.infiniteType! == "TLP")
                            Container(
                              child: Text(" | " + widget.infiniteDetail!.infiniteType!, style: TextStyle(fontSize: Sizes.textSmall, color: Colors.black54)),
                            ),
                          Container(
                            child: Text(" | " + widget.infiniteDetail!.infiniteVersion!, style: TextStyle(fontSize: Sizes.textSmall, color: Colors.black54)),
                          ),
                        ]
                      ),
                    ],
